# 
# Project automation script for Lab4 
# 
# Created for ISE version 10.1
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source Lab4.tcl, then you can
...
set myProject "Lab4.ise"
set myScript "Lab4.tcl"
...
proc add_source_files {} {
   ...
   xfile add "../seven_seg_converter.v"
   xfile add "Binary_Adder_Decrementer_CRTL.v"
   xfile add "Binary_to_BCD_converter.v"
   xfile add "Debouncer_Single_Pulser.v"
   xfile add "bcdToSevenSeg.v"
   xfile add "bcdToSevenSegTop.ucf"
   xfile add "bcdToSevenSegTop.v"
   xfile add "niceDivider.v"

   # Set the Top Module as well...
   project set top "bcdToSevenSegTop"
...
proc set_process_props {} {
   ...
   project set "SmartGuide Filename" "bcdToSevenSegTop_guide.ncd"
